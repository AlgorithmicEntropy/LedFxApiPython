...
class API:
    ...
    def __init__(self, host, port, https=False):
        self.client = rest_client.RESTClient(host, port, '/api/', https)
    ...
    def ledfx_schema_devices(self):
        ...
        :return: JSON obj
        """
        return self.client.get('schema/device')
    ...
    def ledfx_schema_effect(self):
        ...
        :return: JSON obj
        """
        return self.client.get('schema/effect')
    ...
    def ledfx_schema_integration(self):
        ...
        :return: JSON obj
        """
        return self.client.get('schema/integration')
    ...
    def devices_add(self, config):
        ...
        """
        return self.client.post('devices', data=config)

    def devices_all_ids(self):
        """
        Get the ids of all existing devices

        :return: list of ids
        """
        data = self.client.get('devices')
        devices = data['devices']
        ids = [devices[key]['id'] for key in devices.keys()]
        return ids
    ...
    def devices_modify_by_id(self, device_id: str, config):
        ...
        """
        return self.client.put(f"devices/{device_id}", data=config)
    ...
    def effects_get_current(self):
        ...
        :return: JSON obj
        """
        return self.client.get('effects')
    ...
    def effects_by_id(self, effect_id: str):
        ...
        :return: JSON obj
        """
        return self.client.get(f"effects/{effect_id}")
    ...
    def device_get_effect(self, device_id: str):
        ...
        :return: JSON obj
        """
        return self.client.get(f"devices/{device_id}/effects")
    ...
    def device_update_effect(self, device_id: str, effect_config='RANDOMIZE'):
        ...
        :return: JSON obj
        """
        return self.client.put(f"devices/{device_id}/effects", data=effect_config)
    ...
    def device_set_new_effect(self, device_id: str, effect_config):
        ...
        :return: JSON obj
        """
        return self.client.post(f"devices/{device_id}/effects", data=effect_config)
    ...
    def device_delete_effect(self, device_id: str):
        ...
        :return: JSON obj
        """
        return self.client.delete(f"devices/{device_id}/effects")
    ...
    def device_get_presets(self, device_id: str):
        ...
        :return: JSON obj
        """
        return self.client.get(f"devices/{device_id}/presets")
    ...
    def device_set_preset(self, device_id: str, preset):
        ...
        :return: JSON obj
        """
        return self.client.put(f"devices/{device_id}/presets", data=preset)
    ...
    def device_save_as_preset(self, device_id: str, preset_config):
        ...
        :return: JSON obj
        """
        return self.client.post(f"devices/{device_id}/presets", data=preset_config)
    ...
    def device_clear_effect(self, device_id: str):
        ...
        :return: status as JSON obj
        """
        return self.client.delete(f"devices/{device_id}/presets")
    ...
    def effect_get_presets(self, effect_id: str):
        ...
        :return: JSON obj
        """
        return self.client.get(f"effects/{effect_id}/presets")
    ...
    def effect_rename_preset(self, effect_id: str, preset_config):
        ...
        :return: JSON obj
        """
        return self.client.put(f"effects/{effect_id}/presets", data=preset_config)
    ...
    def effect_delete_preset(self, effect_id: str, preset_config):
        ...
        :return: JSON obj
        """
        return self.client.delete(f"effects/{effect_id}/presets", data=preset_config)
    ...
    def scenes_set(self, scene_config):
        ...
        :return: JSON obj
        """
        return self.client.put('scenes', data=scene_config)
    ...
    def scenes_save_current_config_as_scene(self, scene_config):
        ...
        :return: JSON obj
        """
        return self.client.post('scenes', data=scene_config)
    ...
    def scenes_delete_scene(self, scene_config):
        ...
        :return: JSON obj
        """
        return self.client.delete('scenes', data=scene_config)
